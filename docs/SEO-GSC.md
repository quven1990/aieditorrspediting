...
| URL | 状态 | 说明 |
|-----|------|------|
| `https://aieditorrspediting.xyz/robots.txt` | 200 | 正常，末尾含 `Sitemap: https://aieditorrspediting.xyz/sitemap.xml` |
| `https://aieditorrspediting.xyz/sitemap.xml` | 200 | 有效 XML，约 17 个 URL |
...
Sitemap: https://aieditorrspediting.xyz/sitemap.xml
```
...
2. 站点地图 URL 只填：
   ...
   或完整地址 `https://aieditorrspediting.xyz/sitemap.xml`
